...
if __name__ == "__main__":
    ...
    # 训练数据集的根目录(VOCdevkit)
    parser.add_argument('--data-path', default=r'C:\Users\Administrator\Documents\GitHub\deep-learning-for-image-processing\pytorch_object_detection\faster_rcnn', help='dataset')
    # 检测目标类别数(不包含背景)
